...
export class ProductoService {
  products = [
    ...
    { name: 'Carne Molida de Cerdo Tipo II Especial', price: 3.17, image: './asset../../assets/Carne Molida de Cerdo Tipo II Especial.jpg' },
    { name: 'Churrasco de Res', price: 6.37, image: '../../assets/Carnes/Churrasco de Res.jpg' },
