...
@Component({
  selector: 'app-aseo-personal',
  standalone: true,
  imports: [CommonModule, BarraNavegacionComponent, HamburguesaComponent],
  templateUrl: './aseo-personal.component.html',
  styleUrl: './aseo-personal.component.css',
})
export default class AseoPersonalComponent implements OnInit {
  ...
  private loadProducts(): void {
    this.buscarProdService
      .getProductsForCatalogo('aseo_personal')
      .subscribe({
        next: (data) => {
